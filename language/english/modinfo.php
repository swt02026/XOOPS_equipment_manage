...
define('MI_EQUIPMENT_ADMENU3', 'Rentals');
define('MI_EQUIPMENT_ADMENU4', 'Customer');
define('MI_EQUIPMENT_ADMENU5', 'Permissions');
define('MI_EQUIPMENT_ADMENU6', 'About');

define('MI_EQUIPMENT_MENU1', 'VueEquipment');
define('MI_EQUIPMENT_MENU2', 'VueRentals');
define('MI_EQUIPMENT_MENU3', 'Vue FrontEnd');
define('MI_EQUIPMENT_MENU1_DESC', 'Equipment Management with Vue.js');
define('MI_EQUIPMENT_MENU2_DESC', 'Rental List with Vue.js');
define('MI_EQUIPMENT_MENU3_DESC', 'Equipment Rented with Vue.js');
//Blocks
define('MI_EQUIPMENT_EQUIPMENT_BLOCK', 'Equipment block');
define('MI_EQUIPMENT_RENTALS_BLOCK', 'Rentals block');
define('MI_EQUIPMENT_CUSTOMER_BLOCK', 'Customer block');
//Config
...
//vue.js
define('MI_EQUIPMENT_EQUIPMENT_NOT_RETURNED', 'The following equipment is rented out:');
define('MI_EQUIPMENT_MODIFY', 'Modify');
define('MI_EQUIPMENT_BORROWER', 'Customer');
define('MI_EQUIPMENT_BORROWED_QUANTITY', 'Your Order');
define('MI_EQUIPMENT_BORROWING_CONFIRMATION', 'Confirm Order');
define('MI_EQUIPMENT_ALL_RETURNED', 'All returned');
define('MI_EQUIPMENT_DELETE', 'Delete');
define('MI_EQUIPMENT_CANCEL', 'Cancel');
define('MI_EQUIPMENT_CAN_BE_BORROWED', 'You can borrow');
define('MI_EQUIPMENT_THE_HOLDER', 'The holder');
define('MI_EQUIPMENT_OPERATING', 'Operating');
define('MI_EQUIPMENT_ADDED', 'Added');
define('MI_EQUIPMENT_ADD_INFORMATION', 'Add Equipment');
define('MI_EQUIPMENT_NUMBER_OF_RETURNS', 'The number of returns');
define('MI_EQUIPMENT_RETURN_CONFIRMATION', 'Return confirmation');
define('MI_EQUIPMENT_NO_PICTURE', 'No picture');
define('MI_EQUIPMENT_ITEM_NAME', 'Item Name');
define('MI_EQUIPMENT_PHOTO', 'Photo');
define('MI_EQUIPMENT_CONFIRM', 'Confirm');
define('MI_EQUIPMENT_CONFIRM_DELETION', 'Confirm deletion');
define('MI_EQUIPMENT_CONFIRM_DELIVERY', 'Confirm delivery');
define('MI_EQUIPMENT_TOTAL', 'Total');
define('MI_EQUIPMENT_EQUIPMENT_BORROWING', 'Equipment Rental');
define('MI_EQUIPMENT_SENT_OUT', 'Sent out');
define('MI_EQUIPMENT_PART_OF_THE_RETURN', 'Part of the return');
define('MI_EQUIPMENT_SHUT_DOWN', 'Exit');
define('MI_EQUIPMENT_HOLDER', 'Rented by:');
define('MI_EQUIPMENT_OWNER', 'Owner:');
define('MI_EQUIPMENT_QUANTITY', 'Quantity:');
define('MI_EQUIPMENT_EQUIPMENT', 'Equipment:');

//submenu
define('MI_EQUIPMENT_VIEW_INDEX', 'Index:');
define('MI_EQUIPMENT_VIEW_INDEXVUE', 'Index Vue.js:');
