...
<div id="show_record">
    <table class="table">
        <thead>
        <tr>
            <td><h4><{$smarty.const.MI_EQUIPMENT_ITEM_NAME}></h4></td>
            <td><h4><{$smarty.const.MI_EQUIPMENT_BORROWED_QUANTITY}></h4></td>
            <td><h4><{$smarty.const.MI_EQUIPMENT_BORROWER}></h4></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h4><{$smarty.const.MI_EQUIPMENT_BORROWER}>：{{ operating_record.last }}</h4>

                        <div v-if="return_all">
                            <h4> <{$smarty.const.MI_EQUIPMENT_NUMBER_OF_RETURNS}>：{{ operating_record.quantity }}</h4>
                            <input type="hidden"
                                   name="return_amount"
                                   v-model="operating_record.quantity">
                        </div>
                        <div v-else>
    ...
    var vm = new Vue({
        ...
        methods: {
            setReturnAll: function (return_all, record) {
                ...
                this.max_amount = this.operating_record.quantity;
            }
        }
    });
