...
$modversion['templates'][] = ['file' => 'equipment_desc.tpl', 'description' => ''];

$modversion['templates'][] = ['file' => 'equipment_desc_list.tpl', 'description' => ''];
$modversion['templates'][] = ['file' => 'equipment_borrow.tpl', 'description' => ''];

$modversion['templates'][] = ['file' => 'equipment_borrow_list.tpl', 'description' => ''];

$modversion['templates'][] = ['file' => 'admin/equipment_admin_borrow.tpl', 'description' => ''];

$modversion['templates'][] = ['file' => 'admin/equipment_admin_rentals_vue.tpl', 'description' => ''];
$modversion['templates'][] = ['file' => 'admin/equipment_admin_equipment_vue.tpl', 'description' => ''];
